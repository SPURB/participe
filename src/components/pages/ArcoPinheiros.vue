<template>
	<div class="ArcoPinheiros" ref="conteudoConsulta">
		...
		<section>
			...
			<p><strong>Estagiárias de Arquitetura</strong><br>
				Laís Boni Valieris<br>
				Pedro Henrique Aragao Sena
			</p>
