<template>
	<div class="WifiLivreSP" ref="conteudoConsulta">
		...
		<section>
			...
			<Comments :attr="{id:3, context:'ANEXO I – TERMO DE REFERÊNCIA'}" v-if="estaConsulta.ativo == 1"></Comments>
		</section>
		...
		<section>
			...
			<Comments :attr="{id:4, context:'ANEXO II - LOCALIDADES OBRIGATÓRIAS'}" v-if="estaConsulta.ativo == 1"></Comments>
		</section>
		...
		<section>
			...
			<Comments :attr="{id:5, context:'ANEXO III – POSTE E PLACA DE IDENTIFICAÇÃO PARA WIFI'}" v-if="estaConsulta.ativo == 1"></Comments>
		</section>

		<section>
			<h2 class="titulo" indent="1">ANEXO IV – TERMO DE USO E POLÍTICA DE PRIVACIDADE</h2>
			<AnexoBIV></AnexoBIV>
			<Comments :attr="{id:6, context:'ANEXO IV – TERMO DE USO E POLÍTICA DE PRIVACIDADE'}" v-if="estaConsulta.ativo == 1"></Comments>
		</section>
		...
		<section>
			...
			<Comments :attr="{id:7, context:'ANEXO IV – TERMO DE USO E POLÍTICA DE PRIVACIDADE'}" v-if="estaConsulta.ativo == 1"></Comments>
		</section>
