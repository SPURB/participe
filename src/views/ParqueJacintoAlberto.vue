<template>
	<div class="PoliticaMunicipalTurismo" ref="conteudoConsulta">
		<PageTop background_image_src="arquivos/capas/parque_jacinto_alberto.jpg" :esta_consulta="estaConsulta" :social="social_assets">
			<template slot="titulo"><div>PARQUE JACINTHO ALBERTO</div></template>
		...
		<section>
			...
			<p>Este documento se trata do Plano Diretor do Parque Jacintho Alberto, fruto das atividades do Grupo de Trabalho instituído pela Portaria Intersecretarial nº 1/SVMA/SGM/2019. Sua elaboração fora determinada na ocasião de um Acordo junto à Promotoria de Justiça do Meio Ambiente da Capital do Ministério Público do Estado de São Paulo, em meio ao processo de concessão pública do 1° Lote de Parques, o qual contempla, além do Jacinto Alberto, o Ibirapuera, Lajeado, Tenente Brigadeiro Faria Lima, Eucaliptos e Jardim Felicidade.</p>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/3 Inserção Urbana – Leia a minuta aqui na íntegra e contribua.pdf')" target="_blank">
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/4 Diagnóstico – Leia a minuta aqui na íntegra e contribua.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/5 Gestão – Leia a minuta aqui na íntegra e contribua.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/ANEXO 1_Legislação aplicável aos parques urbanos.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/ANEXO 2_Relatório do Herbário.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/ANEXO 3_Inventário da Fauna.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-jacinto-alberto/ANEXO 4_Caderno das diretrizes do Conselho Gestor.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
...
export default {
	...
	methods: {
		fileSrc (fileName) {
			let url = this.$store.getters.basePath + 'arquivos/parque-jacinto-alberto/' + fileName
			return url.toString()
		},
		commentId (isFirst) {
			if (isFirst) {
