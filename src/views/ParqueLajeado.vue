<template>
	<div class="PoliticaMunicipalTurismo" ref="conteudoConsulta">
		...
		<section>
			...
			<p>Este documento se trata do Plano Diretor do Parque Lajeado, fruto das atividades do Grupo de Trabalho instituído pela Portaria Intersecretarial nº 1/SVMA/SGM/2019. Sua elaboração fora determinada na ocasião de um Acordo junto à Promotoria de Justiça do Meio Ambiente da Capital do Ministério Público do Estado de São Paulo, em meio ao processo de concessão pública do 1° Lote de Parques, o qual contempla, além do Lajeado, o Ibirapuera, Eucaliptos, Tenente Brigadeiro Faria Lima, Jacinto Alberto e Jardim Felicidade.</p>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/3 Inserção Urbana – Leia a minuta aqui na íntegra e comente.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
						<div>3 Inserção Urbana – Leia a minuta aqui na íntegra e comente.pdf</div>
						<span>230 KB</span>
					</a>
				</li>
			</ul>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/4 Diagnóstico – Leia a minuta aqui na íntegra e comente.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
						<div>4 Diagnóstico – Leia a minuta aqui na íntegra e comente.pdf</div>
						<span>1,90 MB</span>
					</a>
				</li>
			</ul>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/5 Gestão – Leia a minuta aqui na íntegra e contribua.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
		...
		<section>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/ANEXO 1_Legislação aplicável aos parques urbanos.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/ANEXO 2_Relatório do Herbário.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/ANEXO 3_Inventário da Fauna.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
			...
			<ul class="links">
				<li>
					<a :href="src('arquivos/parque-lajeado/ANEXO 4_Caderno das diretrizes do Conselho Gestor.pdf')" target="_blank">
						<i class="icon-pdf icon"><span>pdf</span></i>
...
export default {
	...
	methods: {
		fileSrc (fileName) {
			let url = this.$store.getters.basePath + 'arquivos/parque-lajeado/' + fileName
			return url.toString()
		},
		commentId (isFirst) {
			if (isFirst) {
