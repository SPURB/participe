<template>
	<div class="SetorCentral2" ref="conteudoConsulta">
		...
		<section>
			...
			<section>
				<h3 class="titulo" indent="2">Abertura</h3>
				<p>A Operação Urbana Centro vai mudar.</p>
				<p>A OU Centro foi instituída pela Lei Municipal nº 12.349, de 6 de junho de 1997, com objetivo de promover a requalificação e a renovação do centro de São Paulo, através preservação do patrimônio edificado, do incremento populacional e do estímulo às atividades típicas de áreas centrais: hoteleira, educacional, cultural e de entretenimento.</p>
				...
				<p>O território compreendido no projeto abrange uma área de 2.098 ha, dos quais 1.485 ha estão contidos no Subsetor Arco Tietê do Setor Orla Ferroviária e Fluvial da Macroárea de Estruturação Metropolitana. A abrangência proposta reinterpreta a setorização da MEM indicada no PDE ao expandir a área identificada como centro metropolitano. O projeto, então, passa a integrar objetivos propostos para o Setor Central e para o Arco Tietê:</p>
				<ol class="romanos">
			...
			<section>
				...
				<p>Os centros comerciais consolidados são também pré-existências a serem valorizadas através das intervenções urbanísticas previstas no projeto: plano de requalificação de logradouros e medidas de regulação de circulação de cargas e da oferta de vagas de estacionamento. A proposta de incremento do uso residencial nesses centros comerciais vem ao encontro de demandas de associações de lojistas que pretendem vitalidade noturna para as ruas fervilhantes de consumidores que se tornam desertas à noite. </p>
				...
				<Tabela :dados="tabela_estrategias"></Tabela>
			</section>
		</section>
		...
		<section>
			...
			<p>Também se propõem a melhoria da conexão entre o Viaduto Bresser e a Rua José Monteiro, consolidando o binário João Boemer – José Monteiro/Bresser como a grande conexão entre o Pari, o Belém e a Mooca; e novos alinhamentos na Av. do Estado, que têm relevância primordialmente ambiental, visando a recuperação da APP do rio Tamanduateí.</p>
			...
			<p>Para a definição das áreas de encosta onde serão privilegiadas as medidas de contenção de águas pluviais e das áreas de várzea onde serão incentivadas as medidas de ampliação da cobertura vegetal, foi traçado o MAPA DE COMPARTIMENTOS AMBIENTAIS, que subsidia a aplicação da Quota Ambiental instituída na lei de Zoneamento e aplicável ao PIU do Setor Central.</p>
		...
		<section>
			...
			<section>
				<h3 class="titulo" indent="2">Habitação e atividade comercial</h3>
				...
				<p class="img">link mapa interativo</p>
				...
				<p>Os logradouros identificados configuraram EIXOS ESTRATÉGICOS, que apresentam incentivo aos usos não residenciais com fachada ativa no térreo, visando a instalação de atividades que deem suporte ao uso residencial nas AEL ou a manutenção de atividades comerciais já existentes.</p>

				<p class="img">mapas eixos residenciais + comerciais + link mapa interativo</p>
			</section>
			...
			<section>
				...
				<Tabela :dados="tabela_densidade"></Tabela>
				...
				<p>Nessas zonas, ainda que os usos residenciais verticais sejam admitidos pelo Zoneamento, estima-se um baixo potencial de transformação de imóveis situados nos polos comerciais de vestuário e de utilidades consolidados, com evidências de investimentos continuados e de vitalidade econômica que extrapola os limites municipais.</p>
				...
				<p class="img">mapas desndidade const + populacional + densidade distritos + links mapa interativo</p>
			</section>
			...
			<section>
				...
				<p class="img">mapa diagrama apoio sul</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">Patrimônio</h3>
				...
				<p class="img">mapa diagrama perimetros tombamentos + dois links mapa interativo</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">Territórios de Transformação, Qualificação e Preservação</h3>
				...
				<p>No âmbito de estudo, estas áreas correspondem aos perímetros de <b>ZEPEC – Zona Especial de Preservação Cultural</b>, que podem abranger: Bens Imóveis Representativos – ZEPEC-BIR, Áreas de Urbanização Especial – ZEPEC-QUE, Áreas de Proteção paisagística – ZEPEC-APPa e Áreas de Proteção Cultural – ZEPEC-APC, e aos perímetros de <b>ZER – Zona Exclusivamente Residencial –</b> inexistentes na área abrangida no projeto.</p>
				...
				<ul>
					<li>Perímetros de <b>ZDE – Zona de Desenvolvimento Econômico</b>, que compreendem, no âmbito de estudo, áreas comerciais e fabris do Bom Retiro e do Pari,</li>
					<li>Perímetros de <b>ZEIS –Zona Especial de Interesse Social</b>, que compreendem áreas da orla ferroviária, da baixada do Glicério e dos distritos do Brás e do Pari, </li>
					<li>Perímetros de <b>ZCOR- Zona Corredor</b>, não encontrados no âmbito do projeto;</li>
					<li>Perímetros de <b>ZM – Zona Mista</b>, que abrangem a orla fluvial do Tietê;</li>
					<li>Perímetros de <b>ZC – Zona de Centralidade</b>, presentes nos distritos Sé, República e Brás, e, como áreas de transição entre zonas, nos distritos do Bom Retiro, do Pari e de Santa Cecília.</li>
				</ul>
				<p>Nos <b>Territórios de Transformação</b>, objetiva-se adensamento construtivo e populacional, intensificação de atividades econômicas e da oferta de serviços públicos, considerada a proximidade das redes de transporte público de média e alta capacidades.  As zonas que caracterizam esses territórios são as <b>Zonas Eixo de Estruturação da Transformação Urbana</b>, subdivididas segundo a localização – dentro ou fora da MEM – e quanto à implantação das redes de transporte – existentes ou previstas.</p>
				<p>As <b>Zonas Eixo de Estruturação da Transformação Urbana</b> são encontradas nos distritos de Santa Cecília, no entorno da estação Santa Cecília da Linha 3 Vermelha do Metrô, e Mooca e Belém, polarizadas pela Linha 3 Vermelha e pelas linhas 10 Turqueza e 11 Coral da CPTM. </p>
				<p>As <b>Zonas Eixo de Estruturação da Transformação Metropolitana</b> são encontradas nos distritos contidos na MEM, abrangendo trechos de Santa Cecília servidos pela Linha 3 Vermelha, pela Linha 4 Amarela e pela Linha 1 Azul do Metrô e pela Linha 7 Rubi e Linha 11 Coral da CPTM.</p>
			...
			<section>
				...
				<p class="img">mapas eixos + link mapa interativo</p>
				...
				<p>Já as Áreas de Transformação T5 apresentam Coeficientes de Aproveitamento Máximo de 2 (duas) vezes a área do terreno, com gabarito estabelecido pela Lei de Zoneamento e sem incidência de Cota de Terreno máxima. No caso de empreendimentos mistos que atendam a cota-parte máxima de terreno por unidade, o Coeficiente de Aproveitamento Máximo poderá ser majorado para até 4 e o gabarito de altura máxima, para até 48 metros.</p>

				<p class="img">mapa setores e eixos .ai : 1</p>
				...
				<p>Os <b>Territórios de Qualificação</b> são territórios consolidados com densidades populacionais média e média-alta onde se pretende o fomento de atividades produtivas.</p>
				<p>O PIU Setor Central explora este conceito e identifica especificidades dentro das áreas de Qualificação. </p>
				<p>Há territórios significativos do Patrimônio Histórico Urbano e Arquitetônico, abrangendo parcelas dos bairros de Santa Ifigênia e Campos Elíseos, classificados em <b>Territórios de Qualificação Q4, Q5, Q6 e Q7</b>, que recebem regramentos específicos para disciplinar as novas construções de forma a integrá-las aos bens preservados, segundo diretrizes trazidas pelo estudo Perímetro de Requalificação de Imóveis Tombados – PRIT* <mark>(nota de rodape)</mark>.</p>
				...
				<p>O <b>Território de Qualificação Q8</b> propõe um Coeficiente de Aproveitamento máximo igual a 6, cujo potencial construtivo a partir do CA 4 até o CA máximo só pode ser obtido mediante Bônus de Potencial Construtivo Adicional, gerados pela produção de HIS 1 em perímetros determinados ou pelo retrofit de edifícios voltados à HIS em todo o âmbito do projeto. </p>
				...
				<p class="img">mapa setores e eixos .ai : 2</p>
				...
				<p>Os <b>Territórios de Preservação</b> buscam consolidar áreas de baixas densidades construtivas, identificando conjuntos urbanos específicos, sejam estes tombados ou possuam atributos urbanísticos merecedores de preservação. Nesse setor, o projeto classifica o Morro do Pari e as Vilas Inglesas e Economizadora, relação que pode ser ampliada após a discussão pública do projeto.</p>
				...
				<p class="img">mapa setores e eixos .ai : 3</p>
		...
		<section>
			...
			<section>
				...
				<ol class="decimais">
					<li>Perímetro: O perímetro aprovado pela Lei Municipal nº 12.349/1997 será alterado, recuperando a abrangência proposta nos estudos técnicos da Operação Urbana Centro à época de sua formulação, nos anos 1990 <mark>nota de rodape</mark>.</li>
					<li>
						...
						<ol class="minusculas">
							...
							<li>A análise caso a caso poderá ser dispensada caso sejam utilizados, nos empreendimentos propostos no âmbito dos distritos Sé e República, os índices constantes do quadro Parâmetros de Ocupação estabelecido para o PIU Setor Central.</li>
							<li>Serão encaminhadas à Câmara Técnica de Legislação Urbanística - CTLU as solicitações que ultrapassarem os índices constantes do quadro Parâmetros de Ocupação estabelecido para o PIU Setor Central.</li>
						</ol>
					</li>
			...
			<section>
				<h3 class="titulo" indent="2">AIU Setor Central</h3>
				...
				<p>A AIU SETOR CENTRAL compartilha com a Operação Urbana Centro objetivos, diretrizes, programa de intervenções, regramento urbanístico, estrat e incentivos estabelecidos no PIU Setor Central, bem como a gestão dos recursos captados nesse âmbito. </p>
				<p>Será coordenada por um Conselho Gestor específico paritário, formado por representantes do Poder Público e da sociedade civil, garantindo-se o controle social na implantação do Programa de Intervenções do PÍU SETOR CENTRAL.</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">AEL da Moradia</h3>
				...
				<p>A intervenção em AEL específica será priorizada por deliberação do Grupo Gestor da AIU SETOR CENTRAL ou Comissão Executiva da OPERAÇÃO URBANA CENTRO.  Previamente ao desenvolvimento do Projeto de Intervenção, caberá à SEHAB a constituição do Conselho Gestor da ZEIS 3 em questão.</p>
				...
				<p class="img">mapa diagramatico 4 ael</p>
		...
		<section>
			...
			<p>Para que sejam atingidos esses objetivos, a São Paulo Urbanismo introduz estratégias de implantação do PIU Setor Central, detalhadas a seguir.</p>
			...
			<section>
				...
				<p class="img">link nota tecnica prit</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">Bônus equivalente</h3>
				...
				<p>Os estudos econômicos que subsidiam o PIU Setor Central quantificaram uma demanda provável de Potencial Construtivo Adicional nessa região, a partir de análises do mercado imobiliário nos últimos anos. </p>
				...
				<p>Os Bônus serão disponibilizados na forma de uma Declaração de Potencial Construtivo Adicional que poderá ser convertida em uma ou mais Certidões de Potencial Construtivo Adicional.</p>
				...
				<section>
					<h4 class="titulo" indent="3">Bonificação para construção de HIS 1</h4>
					<p>Será outorgado um bônus proporcional à área construída destinada a HIS 1, como subsídio do  PIU SETOR CENTRAL  à provisão habitacional destinada a faixa de renda de 1 a 3 SM, nas Áreas de Estruturação Local da Moradia, assinaladas no mapa específico.</p>
					...
					<p class="img">image2.jpeg</p>
				</section>

				<section>
					<h4 class="titulo" indent="3">Bonificação edifícios tombados</h4>
					...
					<p class="img">image3.jpeg</p>
				</section>

				<section>
					<h4 class="titulo" indent="3">Bonificação para Requalificação de edifícios destinados a HIS</h4>
					...
					<p class="img">image4.jpeg</p>
				</section>
			</section>

			<section>
				<h3 class="titulo" indent="2">Parcelamento, Edificação e Urbanização Compulsórios - PEUC</h3>
				...
				<p>O avanço dos trabalhos da CEPEUC, conforme programação disponibilizada na página Função Social da SMDU, cria um vetor de indução ao aproveitamento de imóveis ociosos e subutilizados que é potencializado pelo conjunto de incentivos e estratégias propostos no PIU SETOR CENTRAL.</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">TDC incentivada</h3>
				...
				<p>Onde <pre class="formula declara">PC<sub>pt</sub></pre> é o Potencial Construtivo passível de transferência, <pre class="formula declara">A<sub>tc</sub></pre> é a Área do terreno do imóvel tombado, <pre class="formula declara">F<sub>i</sub></pre> é o Fator de inventivo, conforme Art. 24 da LPUOS<mark>nota de rodape</mark>, <pre class="formula declara">F<sub>CH</sub></pre> é o Fator Centro Histórico, a ser definido pelo DPH/SMC.</p>
				...
				<p>A Declaração de Potencial Construtivo Passível de Transferência deverá ser emitida por SMDU, que manterá seu controle e emitirá as respectivas Certidões de Potencial Construtivo Transferido e Declarações de Saldo de PCpt., atendendo a limitação do §5º do artigo 24 da LPUOS, de 5% do valor arrecadado pelo FUNDURB. </p>
			...
			<section>
				<h3 class="titulo" indent="2">Incentivos diretos</h3>
				...
				<section>
					<h4 class="titulo" indent="3">Regularização onerosa de construções</h4>
				...
				<section>
					<h4 class="titulo" indent="3">Retrofit sem alteração de volumetria de edificações existentes</h4>
				...
				<section>
					<h4 class="titulo" indent="3">Áreas destinadas a educação e cultura</h4>
				...
				<section>
					<h4 class="titulo" indent="3">Remembramento de lotes</h4>
					<p>O incentivo ao remembramento de lotes , nos moldes estabelecidos na Lei Municipal nº 12.349/1997, será mantido na Operação Urbana Centro revisada. Nas orlas fluviais será adotado um incentivo ao remembramento específico, com o objetivo de favorecer a transformação dessas faixas e, em decorrência, promover a recuperação das Áreas de Proteção Permanente dos rios Tietê e Tamanduateí.</p>

					<section>
						<h5 class="titulo" indent="4">Remembramento de lotes na Operação Urbana Centro</h5>
						<p>Os empreendimentos formados pelo remembramento de 3 ou mais lotes e que atinjam o mínimo de 1.000m², terão direito a uma área construída adicional autorizada, livre de contrapartida, correspondente a 10%  da área do terreno resultante por lote remembrado até o limite máximo de 100%.</p>

						<p class="img">image5.png</p>
					</section>

					<section>
						<h5 class="titulo" indent="4">Remembramento de lotes no Setor Orla Fluvial da AIU SETOR CENTRAL – Incentivo de Qualificação da Orla Fluvial</h5>
						...
						<p class="img">image6.jpg</p>
					</section>
				</section>

				<section>
					<h4 class="titulo" indent="3">Reconstrução</h4>
			...
			<section>
				<h3 class="titulo" indent="2">Chamamento público</h3>
		...
		<section>
			...
			<p>Os demais representantes da sociedade civil podem ser escolhidos entre os participantes de outro órgão colegiado eleito, como o CMPU – Conselho Municipal de Política Urbana, vinculado à SMDU – Secretaria Municipal de Desenvolvimento Urbano <mark>nota de rodape</mark>.  O CMPU  é composto por 60 membros, 26 representantes do Poder Público e 34 da sociedade civil, oriundos de organizações variadas que cobrem o leque de temas pertinentes à gestão urbana.</p>

			<section>
				<h3 class="titulo" indent="2">Comissão Executiva da Operação Urbana Centro</h3>
			...
			<section>
				<h3 class="titulo" indent="2">Grupo gestor da AIU Setor Central</h3>
				<p>O Grupo Gestor deverá ter composição paritária entre representantes do Poder Público e da sociedade civil organizada. </p>
				<p>Com o intuito de garantir a integração das ações da Prefeitura, os representantes do Poder Público devem ser indicados entre aqueles que já compõem o colegiado dos Núcleos Regionais de Planejamento* de modo a permitir a troca de informações e a atuação coordenada dos diversos órgãos da administração municipal.</p>
			...
			<section>
				<h3 class="titulo" indent="2">Núcleo técnico de Gestão e Planejamento do PIU Setor Central</h3>
				...
				<p class="img">image8.jpeg</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">PAI – Plano de Ação Integrada</h3>
		...
		<section>
			...
			<section>
				...
				<p class="img">link nota tecnica estoque buffer</p>

				<p>O PIU SETOR CENTRAL, resumido em uma única meta, objetiva o adensamento populacional dos distritos centrais.</p>
				<p>Estudos urbanísticos (ver nota técnica 1) elaborados para estimativa do potencial construtivo atribuído pelo Zoneamento <mark>nota de rodape</mark> aos imóveis contidos no PIU SETOR CENTRAL indicam o expressivo montante de mais de 35 milhões de metros quadrados.</p>
			...
			<section>
				<h3 class="titulo" indent="2">Instrumentos de cessão de Potencial Construtivo Adicional mediante contrapartida financeira ou urbanística</h3>
				...
				<p class="img">image12.jpeg</p>

				<p class="img">image13.jpeg</p>
			</section>

			<section>
				<h3 class="titulo" indent="2">Gestão dos recursos financeiros</h3>
				...
				<p class="img">image14.jpeg</p>
			</section>
		</section>

		<!-- <section ref="allComments">
			<h2 v-show="commentsLoaded" class="titulo" indent="" indent="1">Contribuições</h2>
